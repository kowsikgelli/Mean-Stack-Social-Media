...
exports.updateUser = async(req,res)=>{
    ...
    try{
        ...
        console.log(err)
        res.send({success:false,message:"user deails updation failed",error:err.message})
    }
}
...
exports.deleteUser = async (req,res)=>{
    try{
        ...
        res.send({success:false,message:"user deletion failed",error:err.message})
    }
}
...
exports.getUser = async (req,res)=>{
    try{
        ...
        res.send({success:false,message:"error finding user",error:err.message})
    }
}
