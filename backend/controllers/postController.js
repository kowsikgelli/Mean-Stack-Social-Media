...
exports.updatePost = async (req,res)=>{
    try{
        ...
        res.send({success:false,message:"cannot update a popst",error:err.message})
    }
}
...
exports.deletePost = async (req,res)=>{
    try{
        ...
        res.send({success:false,message:"cannot delete a popst",error:err.message})
    }
}
...
exports.likeOrDislike = async(req,res)=>{
    try{
        ...
        res.send({success:false,message:"cannot like or dislike this post",error:err.message})
    }
}
...
exports.getPost = async(req,res)=>{
    try{
        ...
        res.send({success:false,message:"error fetching the post",error:err.message})
    }
}

exports.getFeed = async(req,res)=>{
    try{
        const currentUserPosts = await Post.find({userId:req.user._id.toString()})
        const currentUserFriends = await User.find({_id:req.user._id.toString()}).select('followings -_id')
